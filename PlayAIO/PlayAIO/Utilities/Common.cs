...
internal static class Common
{
    ...
    {
        if (col.Count > 1 || !ChampionManager.Smite.IsReady())
        {
            return false;
        }
        var obj = col.First();
        return obj.Health <= GetSmiteDmg && obj.DistanceToPlayer() < ChampionManager.SmiteRange
               && Program.Player.Spellbook.CastSpell(ChampionManager.Smite, obj);
    }
